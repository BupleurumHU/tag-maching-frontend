<template>
  <van-cell-group inset>
    ...
    <van-cell title="注册时间" is-link to="/user/edit"  :value="user.createTime.toISOString()" @click="toEdit('createTime','注册时间',user.createTime.toISOString())"/>
  </van-cell-group>
</template>
...
const toEdit = (key:string,title:string,value:string) => {
  route.push({
    path:'/user/edit',
    query:{
      key,
